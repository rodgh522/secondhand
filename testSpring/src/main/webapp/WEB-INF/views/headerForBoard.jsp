...
<body>
    ...
    <header class="header-wrapper">
        <div class="header-top">
            <div class="header-navi-container">
                <div class="header-navi-outer container">
                    ...
                    <div id="navi-md">
                        <button type="button" onclick="$('#categoryToggle').toggle(300);" style="position: absolute; left:0; background-color: inherit; color:white; border: none; line-height: 40px; font-weight: 600;"><span class="fas fa-align-justify icon"></span>&nbsp;&nbsp;<span>카테고리</span></button>
                        <div id="categoryToggle" class="dropdown-menu" style="position: absolute;">
                            <a href="/goList.do?category=c" class="dropdown-item"><span class="fas fa-car icon">&nbsp;</span>자동차</a>
                            <a href="/goList.do?category=p" class="dropdown-item"><span class="fas fa-mobile-alt icon">&nbsp;</span>핸드폰&amp;카메라</a>
                            <a href="/goList.do?category=n" class="dropdown-item"><span class="fas fa-laptop icon">&nbsp;</span>컴퓨터&amp;노트북</a>
                            <a href="/goList.do?category=f" class="dropdown-item"><span class="fas fa-couch icon">&nbsp;</span>가구&amp;가전</a>
                            <a href="/goList.do?category=l" class="dropdown-item"><span class="fas fa-tshirt icon">&nbsp;</span>의류</a>
                        </div>
                    </div>
                    <div class="user-action">
                        ...
                        <div>
                            <button type="button" onclick="location.href='/adminList.do'"><span class="far fa-question-circle"></span><span></span></button></div>
                    </div>
        ...
        <div class="header-bottom">
            <div class="container zIndex">
                ...
                <div class="zIndex"><a href="/goPosting.do" class="post-ad btn btn-success">게시글 등록</a></div>
            </div>
        </div>
            ...
            <div id="search-bar">
                <form action="/searching.do" method="get" class="search-form">
                    <div class="search-categories">
                        <button type="button" onclick="$('.categories').toggle(300)"><span class="fas fa-align-justify icon"></span><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>모든 카테고리</b></span><span class="fas fa-chevron-down">&nbsp;</span></button>
                        <div class="dropdown-menu categories">
                            <a href="javascript:copyCategory(0);" class="dropdown-item">
                                <span class="fas fa-align-justify icon"></span>
                                <span>&nbsp;&nbsp;&nbsp;<b>모든 카테고리</b></span>
                            </a>
                            <a href="javascript:copyCategory(1);" class="dropdown-item">
                                <span class="fas fa-car icon"></span>
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;자동차</span>
                            </a>
                            <a href="javascript:copyCategory(2);" class="dropdown-item">
                                <span class="fas fa-mobile-alt icon"></span>
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;핸드폰/카메라</span>
                            </a>
                            <a href="javascript:copyCategory(3);" class="dropdown-item">
                                <span class="fas fa-laptop icon"></span>
                                <span>&nbsp;&nbsp;&nbsp;컴퓨터/노트북</span>
                            </a>
                            <a href="javascript:copyCategory(4);" class="dropdown-item">
                                <span class="fas fa-couch icon"></span>
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;가전/가구</span>
                            </a>
                            <a href="javascript:copyCategory(5);" class="dropdown-item">
                                <span class="fas fa-tshirt icon"></span>
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;의류</span>
                            </a>
                            <a href="javascript:copyCategory(6);" class="dropdown-item">
                                <span class="fab fa-earlybirds icon"></span>
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;기타</span>
                            </a>
                        </div>
                    </div>
                    <input type="hidden" name="category">
                    <div class="search-input"><input type="text" name="text" placeholder="  검색" style="height: 100%;" value="${search.text}"></div>
                    <div class="search-located"><span class="fab fa-periscope" style="width: 20%; text-align: center; color:#3baa33; "></span><input type="text" name="location" placeholder="지역" value="${search.location}"></div>
                    <div class="search-distant">
                        <button type="button" id="km" onclick="$('#distant').toggle(300);"><span>&nbsp;&nbsp;+&nbsp;&nbsp;0km</span></button>
                        <div id="distant" class="dropdown-menu">
                            ...
                            <a href="javascript:$('[name=distance]').val(100)" class="dropdown-item"><span>&nbsp;&nbsp;+&nbsp;&nbsp;100km</span></a>
                        </div>
                        <input type="hidden" name="distance" value="0">
                    </div>
                    <div class="search-submit"><button type="submit"><span class="fas fa-search"></span></button></div>
                </form>
            </div>
    ...
    <c:if test="${member eq '' || member eq null }">
        <script>
            $('.personal').html('<a href="/goLogin.do" style="line-height : 44px;"> 로그인</a>');
            $('.post-ad').attr('href', '/goLogin.do');

        </script>
    </c:if>
    <script>
        $('.categories .dropdown-item').not($(this).eq(0)).click(function() {
            $('.search-categories button').html($(this).html() + '<span class="fas fa-chevron-down">&nbsp;</span>');
